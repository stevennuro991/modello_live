...
import banner from "../../assets/images/pests.jpeg";
import hover from "../../assets/images/pest2.jpeg";
import cleaninservice from "../../assets/images/aboutus.jpeg";
      ...
      <div className="relative">
        ...
        <div className="absolute md:top-20 top-0 h-full flex flex-col md:pl-20 md:w-[800px] justify-center md:left-0 p-8">
          ...
          <div className="flex space-x-3 items-center text-gray-50 font-extralight">
            ...
            <FaChevronRight color="blue" />
            <p className="text-blue-800 text-ls font-bold" >Pest Control & Fumigation Service</p>
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row md:p-20 md:space-x-20 w-full">
        ...
        <div className="md:w-[60%] md:mr-40 space-y-10 p-5 me:p-0">
          <img
            ...
            alt=""
          />
          <h1 className="md:text-2xl font-bold">Pest Control & Fumigation Service</h1>
          <p className="md:pr-44">
            Our Pest Control & Fumigation Service services at Modello encompass eco-friendly
